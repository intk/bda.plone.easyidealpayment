...
See: https://secure.easyideal.com/ncol/param_cookbook.asp?CSRFSP=%2Fncol%2Ftest%2Fdownload_docs.asp&CSRFKEY=2FA1BDB2690AAD330CAEF5B9F2F7AC73A44FA90A&CSRFTS=20081004115228
...
def get_status_category(status_id):
    """ The easyideal API allows for four kind of results:
        - success
        - cancel
